const zhCN = {
  ...
  about: {
    title: '关于我们',
    description: 'Doki Assistant 正是一以RAG为核心的多Agent多skill个人 AI 工作台，整合多模型对话、RAG 知识库、Skill/Tool 编排、实时翻译和复习管理，帮助你围绕资料、笔记与任务组织长期知识流。',
    techStack: '技术栈',
    features: '功能特性',
    featureList: {
      agent: '多模型 Agent 对话',
      skillsTools: 'Skill / Tool 可配置编排',
      rag: '可追溯 RAG 知识库',
      translate: '实时双语翻译',
      notesReview: '笔记管理与间隔回顾',
    },
    github: 'GitHub 仓库',
  },
  common: {
