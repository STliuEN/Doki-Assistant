const enUS = {
  ...
  about: {
    title: 'About',
    description: 'Doki Assistant is evolving from an intelligent note assistant into a personal AI workspace, combining multi-model chat, RAG knowledge bases, Skill/Tool orchestration, real-time translation, and review workflows for long-term knowledge work.',
    ...
    featureList: {
      ...
      notesReview: 'Notes and spaced review',
    },
