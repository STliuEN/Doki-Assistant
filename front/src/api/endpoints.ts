export const endpoints = {
  ...
  skillDraftCreate: '/api/skills/drafts',
  skillDraftUpdate: (id: string) => `/api/skills/${id}/draft`,
  skillPublish: (id: string) => `/api/skills/${id}/publish`,
  skillDelete: (id: string) => `/api/skills/${id}`,
  skillImports: '/api/skills/imports',
  skillImportDetail: (id: string) => `/api/skills/imports/${id}`,
  skillImportApprove: (id: string) => `/api/skills/imports/${id}/approve`,
  skillSettings: (id: string) => `/api/skills/${id}/settings`,
  skillVersions: (id: string) => `/api/skills/${id}/versions`,
  skillVersionActivate: (id: string, version: string) => `/api/skills/${id}/versions/${version}/activate`,
  skillRollback: (id: string) => `/api/skills/${id}/rollback`,
  skillVersionExport: (id: string, version: string) => `/api/skills/${id}/versions/${version}/export`,
