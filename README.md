...
2026-08-28 复核确认：E1/AR-0/SK-0 已于 2026-08-27 经用户确认关闭；唯一下一阶段 E2/S1/AR-1 已形成[待确认批次计划](./project_changes/2026-08-28-e2-ar1-sql-foundation/plan.md)，但尚未获实施授权。当前仍缺统一 schema、UoW、SQL durable job、单并发 runner、lease/fencing/retry/cancel/DLQ/backpressure 和 E2 恢复证据；工作包 `7-10`、C 级 Skill、公网/多实例/HA 继续受各自门禁约束。E1 关闭不表示 `SKILL-GATE`、`ARCH-GATE` 或发布门禁通过。
