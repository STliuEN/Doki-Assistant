...
本批只固化 E3 的完整开发计划和证据占位，当前状态为 `待你确认`。在用户明确发出 `开始执行e3` 前，不修改代码、不连接数据库、不创建容器、不执行迁移或认证切换。

| 主题 | 方案 | 变更记录 | 验证记录 |
|---|---|---|---|
| E3 AR-2/S2 FastAPI 认证、会话、撤销、角色与审计 | [plan](./2026-08-31-e3-ar2-fastapi-auth/plan.md) | [change log](./2026-08-31-e3-ar2-fastapi-auth/change-log.md) | [test record](./2026-08-31-e3-ar2-fastapi-auth/test-record.md) |
